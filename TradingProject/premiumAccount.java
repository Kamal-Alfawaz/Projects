public class premiumAccount extends sellAll{

    private double balance;
    private double gameStopShares;
    private double appleShares;
    
    //sets the PremiumAccount's balance to default of 0
    ...
    public void sellAllShares() {
        this.balance += (this.gameStopShares*69)*1.2;
        this.balance += (this.appleShares*40)*1.2;
        this.appleShares = 0;
        this.gameStopShares = 0;
    }
